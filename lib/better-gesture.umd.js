(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["better-gesture"] = factory();
	else
		root["better-gesture"] = factory();
...
// CONCATENATED MODULE: ./src/lib/better-gesture.js
    ...
    value: function dispatch(type, args) {
      if (this._Observer[type]) {
        ...
        for (var i = 0, len = this._Observer[type].length; i < len; i++) {
          var handler = this._Observer[type][i];
...
var BetterGesture = /*#__PURE__*/function () {
  function BetterGesture(el) {
    ...
    this.Observer.register('singleTap', option.singleTap); // Mobile Mini
...
//# sourceMappingURL=better-gesture.umd.js.map